...
def man():
    ...
    print(Fore.MAGENTA + "\t sdf -i directorioOrigen ~~ sdf -a -i dirOrigen -o dirDestino")

    print(Fore.BLUE + "\nsdt" + Fore.RED + " --> " + Fore.WHITE + "Envia los archivos de un directorio del servidor al cliente")
    print(Fore.YELLOW + "\t* -i" + Fore.RED + " --> " + Fore.WHITE + "Especifica el directorio origen de la maquina del servidor")
    print(Fore.GREEN + "\t+ -a" + Fore.RED + " --> " + Fore.WHITE + "Indica si se quieren enviar los archivos de forma automatica")
    ...
    print(Fore.BLUE + "\nunzip" + Fore.RED + " --> " + Fore.WHITE + "Descomprime un archivo .zip")
